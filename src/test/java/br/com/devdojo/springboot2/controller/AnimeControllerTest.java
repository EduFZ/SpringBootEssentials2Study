...
@ExtendWith(SpringExtension.class) // inicia o teste sem precisar iniciar o banco de dados
class AnimeControllerTest {
    @InjectMocks // testar classe em si
    private AnimeController animeController;
    @Mock // utiliza para testar todas as classes que estão sendo utilizadas dentro de tal classe
    ...
    void findByName_ReturnsListOfAnime_WhenSuccessful(){
        ...
        List<Anime> animes = animeController.findByName("Star Wars").getBody();
    ...
    @Test
    @DisplayName("findByName returns an empty list anime when is not found")
